...
class Paginator(discord.ui.View):
    ...
    def update_styles(self, **kwargs):
        ...
        self.previous_page_button.label = kwargs.get('previous_button_emoji') or 'Back'
        ...
        self.stop_button.emoji = kwargs.get('stop_button_emoji') or '<a:JKCross:1044579979104632852>'

        # Update the Button Styles
        self.first_page_button.style = kwargs.get('first_button_style') or ButtonStyle.blurple
        self.previous_page_button.style = kwargs.get('previous_button_style') or ButtonStyle.success
        self.stop_button.style = kwargs.get('stop_button_style') or ButtonStyle.red
        self.next_page_button.style = kwargs.get('next_button_style') or ButtonStyle.success
        self.last_page_button.style = kwargs.get('last_button_style') or ButtonStyle.blurple
