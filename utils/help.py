	...
	def gen_embeds(self):
		...
		for cog in self.get_cogs():
			if "help_custom" in dir(cog):
				...
				embed = discord.Embed(title = f"{emoji} {label} Commands",color=0x01f5b6)
				embed.set_footer(text="Made By ~ Hacker_xD#0007", icon_url="https://cdn.discordapp.com/avatars/143853929531179008/a_e45a8d0780fbaa7f34214dff69971924.gif?size=2048")
